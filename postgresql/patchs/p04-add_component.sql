\c interop interop
/* add components */
insert into product(name,product_type,component_type) values ('Outlook',1,1); 
insert into product(name,product_type,component_type) values ('Thunderbird',1,1); 
insert into product(name,product_type,component_type) values ('Evolution',1,1); 
